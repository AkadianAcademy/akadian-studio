...
export default function BuilderSidebar() {
  ...
  const s = {
    wrap: { background: '#0D1117', width: '260px', flexShrink: 0, height: '100vh', overflowY: 'auto' as const, padding: '24px 20px', fontFamily: "'Hanken Grotesk', sans-serif", display: 'flex', flexDirection: 'column' as const, gap: '16px', scrollbarWidth: 'none' as const },
